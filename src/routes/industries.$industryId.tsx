          ...
          <div className="mt-8 flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
            ...
            <div className="flex shrink-0">
               <a
                  ...
                  className="inline-flex items-center gap-1.5 rounded-full bg-foreground px-6 py-3 text-sm font-medium text-background transition-all hover:bg-brand hover:shadow-glow"
                >
        ...
        <div className="overflow-hidden rounded-3xl bg-gradient-brand p-10 text-primary-foreground md:p-14">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer noopener"
              className="inline-flex items-center gap-2 rounded-full bg-background px-6 py-3 text-sm font-medium text-foreground hover:bg-background/90"
            >
              Get started
              <ArrowRight className="h-4 w-4" />
            </a>
